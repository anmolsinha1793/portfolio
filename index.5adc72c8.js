...
*/ var ScrollReveal = function() {
    ...
    function y(e) {
        ...
        try {
            ...
            return h.call(this, "Clean failed.", e1.message);
        }
        if (i) try {
            t.call(this);
        } catch (e2) {
            return h.call(this, "Clean failed.", e2.message);
        }
    }
    function v(n) {
    ...
    function i(e, a, t) {
        ...
        try {
            ...
            return h.call(this, "Reveal failed.", e1.message);
        }
        f(d, function(e) {
    ...
    function H(e) {
        ...
        try {
            ...
            return h.call(this, "Invalid configuration.", e1.message), n.failure();
        }
        try {
            if (!u(t.container)[0]) throw new Error("Invalid container.");
        } catch (e2) {
            return h.call(this, e2.message), n.failure();
        }
